        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdown("VOICE", _selectedVoice, [
                "Male - Deep",
                "Female - Soft",
                "Male - Energetic",
              ...
              _buildDropdown("MODEL", _selectedModel, [
                "Gemini TTS",
                "ElevenLabs",
                "Azure TTS",
              ...
              Text(
                "${_pace.toStringAsFixed(1)}x",
                style: const TextStyle(fontSize: 10, color: Colors.grey),
              ),
              const SizedBox(height: 16),

              _buildDropdown("TONE", _selectedTone, [
                "Neutral",
                "Happy",
                "Sad",
                "Angry",
              ...
              _buildDropdown("STYLE", _selectedStyle, [
                "Conversational",
                "Narrative",
                "News",
