...
class SceneService {
  Future<List<SceneModel>> parseStoryToScenes(String storyText, List<CharacterModel> characters) async {
    return await compute(_processScenes, {'text': storyText, 'chars': characters});
  }
  ...
  static List<SceneModel> _processScenes(Map<String, dynamic> args) {
    ...
    for (var block in blocks) {
      ...
      final presentChars = characters.where((c) => block.contains(c.name)).toList();
